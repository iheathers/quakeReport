    ...
    */
    ...
    public static ArrayList<Earthquake> fetchEarthquakeData(String requestUrl) {
        ...
        try {
            ...
            Log.d(TAG, "fetchEarthquakeData: Error closing input stream");

        }

        ArrayList<Earthquake> earthquakes = extractFeatureFromEarthquakes(jsonResponse);
    ...
    public static ArrayList<Earthquake> extractFeatureFromEarthquakes(String earthquakeJSON) {
        ...
        try {
            ...
            //Log.d(TAG, "extractFeatureFromEarthquakes: " + baseJsonResponse.toString());

            JSONArray earthquakeArray = baseJsonResponse.getJSONArray("features");

            //Log.d(TAG, "extractFeatureFromEarthquakes: " + earthquakeArray.toString());

            for (int i = 0; i < earthquakeArray.length(); i++) {

                // Create JSONObject from SAMPLE_JSON_RESPONSE
                JSONObject currentEarthquake = earthquakeArray.getJSONObject(i);
                Log.d(TAG, "extractFeatureFromEarthquakes: " + currentEarthquake);
                // Extract JSONArray from currentEarthquake JSONObject
                JSONObject properties = currentEarthquake.getJSONObject("properties");

                // Extract magnitude, location and time from properties JSONObject
                ...
                Earthquake earthquake = new Earthquake(formattedMagnitude, location, time, url);

                // Append earthquake to earthquakes arraylist
